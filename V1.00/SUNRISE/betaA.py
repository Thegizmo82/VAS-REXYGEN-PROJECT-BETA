...
while CivilTimeStart < datetime.datetime.now().strftime('%H:%M') or CivilTimeEnd < datetime.datetime.now().strftime('%H:%M'):
       
   time.sleep(1)
print ('UVB-H Active')
print ('UVB-C Active')

while SunRiseStart < datetime.datetime.now().strftime('%H:%M') or SunSetEnd < datetime.datetime.now().strftime('%H:%M'):
