...
#sunrise_hours will be in 24-hour GMT.
    if isdst == 1: #Add your timezone offset when DST is observed,(-4), to the time:
        sunrise_hours = sunrise_hours + 20
    else: #Add your timezone offset when DST is not observed,(-5), to the time:
        sunrise_hours = sunrise_hours + 19
...
#suntransit_hours will be in 24-hour GMT.
    if isdst == 1: #Add your timezone offset when DST is observed,(-4), to the time:
        suntransit_hours = suntransit_hours + 20
    else: #Add your timezone offset when DST is not observed,(-5), to the time:
        suntransit_hours = suntransit_hours + 19
...
#sctle_hours will be in 24-hour GMT.
    if isdst == 1: #Add your timezone offset when DST is observed,(-4), to the time:
        sctle_hours = sctle_hours + 20
    else: #Add your timezone offset when DST is not observed,(-5), to the time:
        sctle_hours = sctle_hours + 19
...
#mr_hours will be in 24-hour GMT.
    if isdst == 1: #Add your timezone offset when DST is observed,(-4), to the time:
        mr_hours = mr_hours + 20
    else: #Add your timezone offset when DST is not observed,(-5), to the time:
        mr_hours = mr_hours + 19
...
#mt_hours will be in 24-hour GMT.
    if isdst == 1: #Add your timezone offset when DST is observed,(-4), to the time:
        mt_hours = mt_hours + 20
    else: #Add your timezone offset when DST is not observed,(-5), to the time:
        mt_hours = mt_hours + 19
...
# Code Fialts: First night run: time_io_beta1(NO IO).py
#Traceback (most recent call last):
#  File "time_io_beta1.py", line 220, in <module>
#    ms_time = datetime.time(ms_hours, ms_minutes)
