...
try:
    os.makedirs ('/rex/data/ramdisk/dht_z2')
except OSError:
    if not os.path.isdir ('/rex/data/ramdisk/dht_z2'):
        raise
...
file_SENSOR = open('/rex/data/static/DHT_Z2_SENSOR.txt', 'r')
...
file_PIN = open('/rex/data/static/DHT_Z2_PIN.txt', 'r')
pin = file_PIN.read()
file_PIN.close()
...
file_temperature = open('/rex/data/ramdisk/dht_z2/TC.txt', 'w')
...
file_temperature_f = open('/rex/data/ramdisk/dht_z2/TF.txt', 'w')
...
file_humidity = open('/rex/data/ramdisk/dht_z2/RH.txt', 'w')
