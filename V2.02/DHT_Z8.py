...
try:
    os.makedirs ('/rex/data/ramdisk/dht_z8')
except OSError:
    if not os.path.isdir ('/rex/data/ramdisk/dht_z8'):
        raise
...
file_SENSOR = open('/rex/data/static/DHT_Z8_SENSOR.txt', 'r')
...
file_PIN = open('/rex/data/static/DHT_Z8_PIN.txt', 'r')
pin = file_PIN.read()
file_PIN.close()
...
file_temperature = open('/rex/data/ramdisk/dht_z8/TC.txt', 'w')
...
file_temperature_f = open('/rex/data/ramdisk/dht_z8/TF.txt', 'w')
...
file_humidity = open('/rex/data/ramdisk/dht_z8/RH.txt', 'w')
