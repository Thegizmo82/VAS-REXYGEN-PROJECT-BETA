...
try:
    os.makedirs ('/rex/data/ramdisk/dht_z3')
except OSError:
    if not os.path.isdir ('/rex/data/ramdisk/dht_z3'):
        raise
...
file_SENSOR = open('/rex/data/static/DHT_Z3_SENSOR.txt', 'r')
...
file_PIN = open('/rex/data/static/DHT_Z3_PIN.txt', 'r')
pin = file_PIN.read()
file_PIN.close()
...
file_temperature = open('/rex/data/ramdisk/dht_z3/TC.txt', 'w')
...
file_temperature_f = open('/rex/data/ramdisk/dht_z3/TF.txt', 'w')
...
file_humidity = open('/rex/data/ramdisk/dht_z3/RH.txt', 'w')
