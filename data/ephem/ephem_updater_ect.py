...
try:
    os.makedirs ('/rex/data/ramdisk/end_civil_twilight')
except OSError:
    if not os.path.isdir ('/rex/data/ramdisk/end_civil_twilight'):
        raise
...
# WRITE FILE UTC HOUR
file_utc_hour = open('/rex/data/ramdisk/end_civil_twilight/utc_hour.txt', 'w')
file_utc_hour.write((loc_hour))
file_utc_hour.close()

# WRITE FILE UTC MINUTE
file_utc_minute = open('/rex/data/ramdisk/end_civil_twilight/utc_minute.txt', 'w')
file_utc_minute.write((loc_minute))
file_utc_minute.close()

# WRITE FILE UTC SECOND
file_utc_second = open('/rex/data/ramdisk/end_civil_twilight/utc_second.txt', 'w')
file_utc_second.write((loc_second))
file_utc_second.close()

# WRITE FILE UTC MONTH
file_utc_month = open('/rex/data/ramdisk/end_civil_twilight/utc_month.txt', 'w')
file_utc_month.write((loc_month))
file_utc_month.close()

# WRITE FILE UTC DAY
file_utc_day = open('/rex/data/ramdisk/end_civil_twilight/utc_day.txt', 'w')
file_utc_day.write((loc_day))
file_utc_day.close()

# WRITE FILE UTC YEAR
file_utc_year = open('/rex/data/ramdisk/end_civil_twilight/utc_year.txt', 'w')
file_utc_year.write((loc_year))
file_utc_year.close()

# WRITE FILE UTC WEEKDAY
file_utc_weekday = open('/rex/data/ramdisk/end_civil_twilight/utc_weekday.txt', 'w')
file_utc_weekday.write((loc_weekday))
file_utc_weekday.close()

# WRITE FILE UTC DAY OF YEAR
file_utc_dayyear = open('/rex/data/ramdisk/end_civil_twilight/utc_dayyear.txt', 'w')
file_utc_dayyear.write((loc_dayyear))
file_utc_dayyear.close()

# WRITE FILE UTC WEEK OF YEAR
file_utc_weekyear = open('/rex/data/ramdisk/end_civil_twilight/utc_weekyear.txt', 'w')
file_utc_weekyear.write((loc_weekyear))
file_utc_weekyear.close()

# WRITE FILE UTC, LOCALE'S APPROPRIATE DATE REPRESENTATION
file_utc_lapd = open('/rex/data/ramdisk/end_civil_twilight/utc_lapd.txt', 'w')
file_utc_lapd.write((loc_lapd))
file_utc_lapd.close()

# WRITE FILE UTC, LOCALE'S APPROPRIATE TIME REPRESENTATION
file_utc_lapt = open('/rex/data/ramdisk/end_civil_twilight/utc_lapt.txt', 'w')
file_utc_lapt.write((loc_lapt))
file_utc_lapt.close()

# WRITE FILE LOCAL HOUR
file_loc_hour = open('/rex/data/ramdisk/end_civil_twilight/loc_hour.txt', 'w')
file_loc_hour.write((loc_hour))
file_loc_hour.close()

# WRITE FILE LOCAL MINUTE
file_loc_minute = open('/rex/data/ramdisk/end_civil_twilight/loc_minute.txt', 'w')
file_loc_minute.write((loc_minute))
file_loc_minute.close()

# WRITE FILE LOCAL SECOND
file_loc_second = open('/rex/data/ramdisk/end_civil_twilight/loc_second.txt', 'w')
file_loc_second.write((loc_second))
file_loc_second.close()

# WRITE FILE LOCAL MONTH
file_loc_month = open('/rex/data/ramdisk/end_civil_twilight/loc_month.txt', 'w')
file_loc_month.write((loc_month))
file_loc_month.close()

# WRITE FILE LOCAL DAY
file_loc_day = open('/rex/data/ramdisk/end_civil_twilight/loc_day.txt', 'w')
file_loc_day.write((loc_day))
file_loc_day.close()

# WRITE FILE LOCAL YEAR
file_loc_year = open('/rex/data/ramdisk/end_civil_twilight/loc_year.txt', 'w')
file_loc_year.write((loc_year))
file_loc_year.close()

# WRITE FILE LOCAL WEEKDAY
file_loc_weekday = open('/rex/data/ramdisk/end_civil_twilight/loc_weekday.txt', 'w')
file_loc_weekday.write((loc_weekday))
file_loc_weekday.close()

# WRITE FILE LOCAL DAY OF YEAR
file_loc_dayyear = open('/rex/data/ramdisk/end_civil_twilight/loc_dayyear.txt', 'w')
file_loc_dayyear.write((loc_dayyear))
file_loc_dayyear.close()

# WRITE FILE LOCAL WEEK OF YEAR
file_loc_weekyear = open('/rex/data/ramdisk/end_civil_twilight/loc_weekyear.txt', 'w')
file_loc_weekyear.write((loc_weekyear))
file_loc_weekyear.close()

# WRITE FILE LOCAL, LOCALE'S APPROPRIATE DATE REPRESENTATION
file_loc_lapd = open('/rex/data/ramdisk/end_civil_twilight/loc_lapd.txt', 'w')
file_loc_lapd.write((loc_lapd))
file_loc_lapd.close()

# WRITE FILE LOCAL, LOCALE'S APPROPRIATE TIME REPRESENTATION
file_loc_lapt = open('/rex/data/ramdisk/end_civil_twilight/loc_lapt.txt', 'w')
