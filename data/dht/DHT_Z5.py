...
try:
    os.makedirs ('/rex/data/ramdisk/dht_z5')
except OSError:
    if not os.path.isdir ('/rex/data/ramdisk/dht_z5'):
        raise
...
file_SENSOR = open('/rex/data/static/DHT_Z5_SENSOR.txt', 'r')
...
file_PIN = open('/rex/data/static/DHT_Z5_PIN.txt', 'r')
pin = file_PIN.read()
file_PIN.close()
...
file_temperature = open('/rex/data/ramdisk/dht_z5/TC.txt', 'w')
...
file_temperature_f = open('/rex/data/ramdisk/dht_z5/TF.txt', 'w')
...
file_humidity = open('/rex/data/ramdisk/dht_z5/RH.txt', 'w')
